<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ControlForEditRate.ascx.cs" Inherits="OnlineRates.Controls.ControlForEditRate" %>
            ...
            <td>
                <div>
                    <div style="float: left;">
                        <asp:ImageButton ID="ibtnSaveRateChanges" runat="server" 
                            ImageUrl="~/Images/RatesInBanks/onebit_12.png" onclick="ibtnSave_Click" 
                            Height="30px" Width="30px" />
                    </div>
                    <div style="float: left;">
                        <asp:ImageButton ID="ibtnCansel" runat="server" 
                            ImageUrl="~/Images/RatesInBanks/onebit_11.png" 
                            Height="30px" Width="30px" onclick="ibtnCansel_Click" CausesValidation="False" />
                    </div>
                </div>
            </td>
        </tr>
